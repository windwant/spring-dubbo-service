package org.windwant.serverx.core.aop;
...
public class CatAspect {
    ...
    private static final String CAT_TYPE = "sdubbo.log";

    private static final String CAT_TYPE_NAME = "sdubbo.log";

    private static final String CAT_METHOD_NAME = "hello";

    @Pointcut("execution(* org.windwant.spring.service.impl.*.*(..))")
    public void log(){}
