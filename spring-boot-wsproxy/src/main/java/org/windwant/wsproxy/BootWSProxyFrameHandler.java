 ...
 *
 */
public class BootWSProxyFrameHandler extends SimpleChannelInboundHandler<Object> {

    private static final Logger logger = LoggerFactory.getLogger(BootWSProxyFrameHandler.class);
    ...
    public BootWSProxyFrameHandler() {
    }
    ...
    protected void channelRead0(ChannelHandlerContext context, Object webSocketFrame) throws Exception {
        if (webSocketFrame instanceof BinaryWebSocketFrame) {
            ...
            if (BootWSProxyChannelManager.getUserChannel(requestCode) == null) {
                    BootWSProxyChannelManager.registerUserChannel(requestCode, context.channel());

            }

            BusiWSHandler.dealBusi(context, bootRequest, DubboSvr.dubboService);
