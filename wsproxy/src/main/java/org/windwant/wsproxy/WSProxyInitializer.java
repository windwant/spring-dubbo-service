...
/**
 * ChannelInitializer 一种特定的ChannelInboundHandler 提供一种简单的方法来初始化注册到EventLoop的channel
 */
...
//
        ...
        pipeline.addLast(new WebSocketServerProtocolHandler(ConfigUtil.get("ws.connect.path")));
