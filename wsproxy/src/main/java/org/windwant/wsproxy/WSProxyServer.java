...
public class WSProxyServer {
    ...
    private void start() throws InterruptedException {
        ...
        try {
            ...
            channelFuture = bootstrap.bind(ConfigUtil.getInteger("ws.connect.port"));
            ...
            wsServiceId = RegistryFactory.INSTANCE.
                    ...
                    doRegister(RegistryService.build(NetUtil.getHost() + "/" + ConfigUtil.get("service.name"),
                            NetUtil.getHost(),
                            ConfigUtil.getInteger("ws.connect.port"),
            ...
            //绑定端口
            busChannelFuture = busServerBootStrap.bind(ConfigUtil.getInteger("ws.connect.bus.port"));
            ...
            wsPushServiceId = RegistryFactory.INSTANCE.
                    ...
                    doRegister(RegistryService.build(NetUtil.getHost() + "/" + ConfigUtil.get("service.bus.name"),
                            NetUtil.getHost(),
                            ConfigUtil.getInteger("ws.connect.bus.port"),
                            ConfigUtil.get("service.bus.version")));
        } catch (Exception e) {
            logger.error("ws proxy start failed", e);
