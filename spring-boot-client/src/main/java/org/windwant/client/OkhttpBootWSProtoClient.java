...
import org.windwant.client.util.BootUtil;
 ...
 */
public class OkhttpBootWSProtoClient {

    private static final Logger logger = LoggerFactory.getLogger(OkhttpBootWSProtoClient.class);
    ...
    public static void main(String[] args) {
        ...
        WebSocket webSocket = okHttpClient.newWebSocket(request, new WebSocketListener() {
            ...
            public void onOpen(WebSocket webSocket, Response response) {
                ...
                for (int i = 0; i < 100; i++) {
                    webSocket.send(ByteString.of(BootUtil.getByteBufBootRequest(ThreadLocalRandom.current().nextInt()).array()));
                }
            }
